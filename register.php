...
<div class="container">
  ...
  <form action="register.php" method="POST" enctype="multipart/form-data">
    ...
    <br> <input type="text" value=""name="username" placeholder="Prisijungimo vardas" required > <br>
    ...
    <br> <input type="password" name="confirmpassword" placeholder="Slaptazodzio patvirtiniams" required > <br>

    <input type="file" name="avatar" id="avatar">
    
    <br><input type="submit" value="Registracija" name="submit"/>
